...
- **Dashboard window**: four tabs — *Time* (stacked day/week bars, topic drill-down), *Vault* (today's work log, tasks, themes — §5.3), *Cards* (home screen with activity heatmap + card urgency; inbox and review as separate screens — §5.2), *Radar* (suggestions). Charts native SwiftUI; no web views.
